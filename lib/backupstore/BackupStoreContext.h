...
public:
	...
	void DeleteDirectory(int64_t ObjectID, bool Undelete = false, bool Recurse=true);
...
private:
	...
	void DeleteDirectoryRecurse(int64_t ObjectID, bool Undelete, box_time_t ActionTime);
